    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(text="Owner", url=f"https://t.me/oppaiddaisukii"),
                    InlineKeyboardButton(text="Group", url=f"https://t.me/Friendlycircle"),
                ],
                [InlineKeyboardButton(text="Close", callback_data="cls")],
            ]
        )
...
async def deezer(client: Client, message_: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton(text="Owner", url=f"https://t.me/oppaidaisukii")],
            [InlineKeyboardButton(text="Close", callback_data="cls")],
        ]
    )
        ...
        [
            ...
            [
                InlineKeyboardButton(
                    text="Owner Zelda", url=f"https://t.me/oppaidaisukii"
                )
            ],
            [InlineKeyboardButton(text="Close", callback_data="cls")],
        ]
